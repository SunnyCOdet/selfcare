...
- ARITHMETIC MUST RECONCILE: list per-item macros for every meal item and a per-meal total in the meal's notes; the SUM of all meal totals must match daily_calories / protein_g / carbs_g / fat_g within 5 percent. Use standard reference values: whole egg = 6g protein / 5g fat / 72 kcal; whey scoop (30g) = 24g protein / 120 kcal; raw white rice per 100g = 78g carbs / 7g protein / 350 kcal; cooked rice has ~1/3 the density of raw; oil = 9 kcal per gram, 14g per tbsp; chicken breast per 100g raw = 22g protein / 120 kcal; paneer per 100g = 18g protein / 20g fat / 265 kcal. Add the numbers up and adjust portions until the totals reconcile BEFORE responding — never publish meal totals that exceed the stated daily fat/protein/carb targets.
